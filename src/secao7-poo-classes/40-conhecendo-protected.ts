...
class Admin extends Usuario {
  ...
  // código do professor sem pârametro:
  // acessarAdmin() {
  //   this.mudarCargo("Designer");
  // }

  acessarAdmin(cargo: string) {
...
// console.log(usuario1.id) //Property 'id' is protected and only accessible within class 'Usuario' and its subclasses.

 // código do professor sem argumento:
//usuario1.acessarAdmin();

usuario1.acessarAdmin('Designer');
